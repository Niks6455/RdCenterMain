...
<head>
    ...
    <link rel="shortcut icon" href="./assets/images/generalPictures/logo/logo.svg">
...
<body>
    <img src="./assets/images/R&dMain/background/главная.svg" alt="home-background" class="home-background">
    <header class="header">
        <div class="header_content_inner">
            <div class="header__logo">
                <a href="#topSite"><img src="./assets/images/generalPictures/logo/logo.svg" alt="header-icon"></a>
            </div>
            <div class="nawPc">
            ...
            <div class="header__burger" id="burgerMenu">
                ...
                <div class="nav__header_mobl">
                    ...
                    <img class="girl__boorger" src="./assets/images/R&dMain/moble/boorgerHeadermob.svg">
                </div>
            </div>
    ...
    <div class="container">
        <div class="main__page" id="topSite">
            ...
            <img class="imgMainLine" src="./assets/images/R&dMain/moble/mainLine.svg">
            <img src="./assets/images/R&dMain/background/center.svg" alt="home-background" class="home-background-center">
            <img src="./assets/images/generalPictures/logo/лого главная.svg" alt="home-background" class="home-background-logoGlav">
            <a href="#about"> <img src="./assets/images/R&dMain/icon/стрелка-скрол.svg" alt="home-background"
                    class="home-background-arrow"></a>
        </div>

        <div class="About" id="about">
            <img class="AboutLine" src="./assets/images/R&dMain/ui/блок о нас.svg">
            <img class="peopleAbout" src="./assets/images/R&dMain/moble/peopleAbout.svg">
            <div class="aboutTxet">
                ...
                <div class="buttonText">
                    <img class="btnabout" src="./assets/images/R&dMain/moble/imgArrowAb.svg">
                </div>
        ...
        <div class="Services" id="services">
            <img src="./assets/images/R&dMain/ui/блок услуги.svg">
            <img class="bg__service" src="./assets/images/R&dMain/background/black-services-bg.svg">
            <div class="Services__inner">
                <div class="Services__inner__block1">
                    <p>Разработка веб приложений</p>
                    <img class="img_servBlock" src="./assets/images/R&dMain/ui/LW_service.svg">
                </div>
                <div class="Services__inner__block2">
                    <p>Разработка программно-аппаратных решений</p>
                    <img class="img_servBlock" src="./assets/images/R&dMain/ui/PW_service.svg">
                </div>
                <div class="Services__inner__block3">
                    <p>Разработка мобильных приложений</p>
                    <img class="img_servBlock" src="./assets/images/R&dMain/ui/LN_service.svg">
                </div>
                <div class="Services__inner__block4">
                    <p>Разработка решений IoT</p>
                    <img class="img_servBlock" src="./assets/images/R&dMain/ui/PN_service.svg">
                </div>
        ...
        <img class="ServicesMobleBg" src="./assets/images/R&dMain/moble/bgService.svg" alt="">
        <div class="ServicesMobile" id="servicesmob">
            <img style="display: none;" src="./assets/images/R&dMain/moble/lineservTop.svg">
                    ...
                    <div>
                        <div class="blockMobText__inner">
                            <div class="blockMobText__img" style="width: 50px;">
                                <img src="./assets/images/R&dMain/moble/galocha.svg">
                            </div>
        ...
        <div class="Project" id="projects">
            <img src="./assets/images/R&dMain/ui/project.svg" style="position: absolute; right: 0;">
            <img src="./assets/images/R&dMain/ui/program.svg" style="position: relative; top: 150px;">
            <div class="projcet_Program">
                <div class="block__prog__program__inner">
                    <div class="block_img_proj">
                        <a href="https://play.google.com/store/apps/details?id=com.sfedu.crafsed.taganrogdefence&pli=1"
                            target="_blank"><img src="./assets/images/R&dMain/ui/project/конь.svg">
                    </div>
                    <div class="block_text_proj">
                        <p>Фестиваль “Оборона Таганрога”</p>
                    </div></a>
                    <img style="position: absolute; bottom: 30px; right: 0;" src="./assets/images/R&dMain/ui/project/line.svg">
                ...
                <div class="block__prog__program__inner">
                    <div class="block_img_proj">
                        <a href="https://apps.apple.com/ru/app/амброзия/id1620858412?l=en" target="_blank"><img
                                ...
                                src="./assets/images/R&dMain/ui/project/амброзия.svg">
                    </div>
                    <div class="block_text_proj">
                        <p>Амброзия</p>
                    </div></a>
                ...
                <div class="block__prog__program__inner block__goTop">
                    <div class="block_img_proj">
                        <a href="https://rdcenter.ru/practice"> <img src="./assets/images/R&dMain/ui/project/биржа.svg"></a>

                    </div>
                    <div class="block_text_proj">
                        <p>Биржа практик</p>
                    </div></a>
                    <img style="position: absolute; bottom: 10px; right: 0;" src="./assets/images/R&dMain/ui/project/line.svg">
            ...
            <div class="projcet_Apparat" >
                <div class="projcet_Apparat_img">
                    <img src="./assets/images/R&dMain/ui/apparat.svg">
                </div>
                <div class="projcet_Apparat_block">

                    <div class="block__prog__program__inner">
                        <div class="block_img_proj">
                            <img src="./assets/images/R&dMain/ui/project/stm32.svg">
                        </div>
                        <div class="block_text_proj">
                            <p>Лабораторный стенд STM32</p>
                        </div>
                        <img style="position: absolute; bottom: 30px; right: 0; display: none;"
                            src="./assets/images/R&dMain/ui/project/line.svg">
                    ...
                    <div class="block__prog__program__inner">
                        <div class="block_img_proj">
                            <img src="./assets/images/R&dMain/ui/project/муссорки.svg">
                        </div>
                        <div class="block_text_proj">
                    ...
                    <div class="block__prog__program__inner">
                        <div class="block_img_proj">
                            <img src="./assets/images/R&dMain/ui/project/пешеход.svg">
                        </div>
                        <div class="block_text_proj">
        ...
        <div class="ProjectMoble" id="projectsmob">
            <img class="lineProject" src="./assets/images/R&dMain/moble/lineProject.svg">
            <div class="slider-container">
                <div class="slider-container">

                    <div class="slide ">
                        <div class="slide__inner">
                           <a href="https://play.google.com/store/apps/details?id=com.sfedu.crafsed.taganrogdefence&pli=1" target="_blank"><img src="./assets/images/R&dMain/ui/project/конь.svg"></a> 
                            <div class="textmob">
                    ...
                    <div class="slide ">
                        <div class="slide__inner">
                            <a href="https://apps.apple.com/ru/app/амброзия/id1620858412?l=en" target="_blank"><img src="./assets/images/R&dMain/ui/project/амброзия.svg"></a>
                            <div class="textmob">
                                <div class="block_text_projMoble">
                                    <div class="nameProj">
                                        <p>Амброзия</p>
                 ...
                 <div class="button__slider">
                    <button class="btn_prev"><img src="./assets/images/practiceExchange/icon/btnStand.png"></button>
                    <button class="btn_next"><img src="./assets/images/practiceExchange/icon/btnStand.png"></button>
                </div>
                <div class="dots"></div>
            </div>
        </div>
        ...
        <div class="container" id="contact">
            <div class="footer__inner">
                ...
                <div class="footerSvazLine" style="position: relative; top: 50px;"><img
                        src="./assets/images/R&dMain/moble/footerLine.svg"></div>
                <div class="block_line"><img src="./assets/images/R&dMain/ui/footer__line.svg"></div>
                <div class="block_form">
                    <div>
                        <form enctype="multipart/form-data" class="contact__form" method="post" action="SubmitForm.php" >
                            ...
                            <img class="screp" src="./assets/images/R&dMain/ui/screp.svg">
                        </form>
                ...
                <div class="block_logoFooter">
                    <img src="./assets/images/generalPictures/logo/footer__logo.svg">
                </div>
                <div class="Psbottom">
